export const levelOne = {
  ...
  theories: {
    ...
    'i-4': {
      ...
      content:
        "<br>No, I won't give you my phone number for free, but you can have my instagram: <a href='https://www.instagram.com/jimmynluong/'>@jimmynluong</a><br><br>",
      image: '../assets/thumbsup.gif',
    },
  },
  tasks: {
